...
sub showContentForIndex(index as Integer)
    ...
    if index = 0
        ...
        m.contentBody.text  = "Built using Roku SceneGraph and BrightScript with a modular, component-driven architecture featuring persistent navigation, delegated screens, and scalable UI patterns without duplicated logic."
